...
<body class="bg-white text-gray-900">
    ...
    <nav class="fixed top-0 left-0 w-56 h-full bg-white shadow-md flex flex-col items-center py-6 z-10 hidden md:flex">
        ...
        <div id="forNav" class="flex flex-col items-center justify-center space-y-4 w-full text-center">
            <a href="{{ route('SellerDashboard') }}" class="menu-link text-[#6e4d41] w-[100px] hover:text-gray-500 font-medium py-3 transition duration-300 {{ request()->routeIs('SellerDashboard') ? '' : 'opacity-50'}}">DASHBOARD</a>
            <a href="{{ route('SellerArtworks') }}" class="menu-link text-[#6e4d41] w-[100px] hover:text-gray-500 font-medium py-3 transition duration-300 {{ request()->routeIs('SellerArtworks') ? '' : 'opacity-50'}}">ARTWORKS</a>
            <a href="{{ route('SellerOrders') }}" class="menu-link text-[#6e4d41] w-[100px] hover:text-gray-500 font-medium py-3 transition duration-300 {{ request()->routeIs('SellerOrders') ? '' : 'opacity-50'}}">ORDERS</a>
        </div>
