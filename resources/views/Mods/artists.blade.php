...
<body  class="bg-white text-gray-900">
    ...
    <div id="mobileMenu" class="hidden fixed inset-0 bg-white flex flex-col items-center justify-top space-y-7  shadow-md z-40">
        ...
        <a id="navmobi" href="{{ route('drawings') }}"  class="menu-link opacity-60  transition duration-500 ">DRAWINGS</a>
        <a id="navmobi" href="{{ route('sculptures') }}"  class="menu-link  opacity-60 transition duration-500 ">SCULPTURE</a>
        <a id="navmobi" href="{{ route('artists') }}" style="text-decoration: underline;text-underline-offset: 23px;text-decoration-thickness:2px; " class="menu-link flex items-center justify-center  text-[#6e4d41] hover:text-gray-500 font-medium h-[60px] px-3  transition duration-500 ">ARTISTS</a>
