    ...
    <div class="container-fluid py-5 px-4">
        ...
        <div class="card">
            <div class="card-image">
                <img src="images/drawing.jpg" alt="Artwork">
        ...
        <div class="card">
            <div class="card-image">
                <img src="images/drawing1.jpg" alt="Artwork">
                <div class="card-overlay">
                    <h5 class="card-title">LOREM IPSUM</h5>
                    <h6 class="artist">By Artist</h6>
                    <p class="card-text">Lorem Ipsum</p>
        ...
        <div class="card">
            <div class="card-image">
                <img src="images/drawing2.jpg" alt="Artwork">
                <div class="card-overlay">
                    <h5 class="card-title">LOREM IPSUM</h5>
                    <h6 class="artist">By Artist</h6>
                    <p class="card-text">Lorem Ipsum</p>
        ...
        <div class="card">
            <div class="card-image">
                <img src="images/drawing3.jpg" alt="Artwork">
                <div class="card-overlay">
                    <h5 class="card-title">LOREM IPSUM</h5>
                    <h6 class="artist">By Artist</h6>
                    <p class="card-text">Lorem Ipsum</p>
