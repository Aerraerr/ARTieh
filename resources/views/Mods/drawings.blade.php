...
<body  class="bg-white text-gray-900">
    ...
    <nav style="height:60px;" class="flex justify-between items-center px-10 py-6 shadow-sm bg-transparent">
        ...
        <div id="forNav" style="margin-left:600px;" class="mr-2  hidden md:flex space-x-2" style="font-family: 'Rubik', sans-serif;  ">
            ...
            <a href="{{ route('drawings') }}" style="text-decoration: underline;text-underline-offset: 23px;text-decoration-thickness:2px; " class="flex items-center justify-center  text-[#6e4d41] hover:text-gray-500 font-medium h-[60px] px-3  transition duration-300 ">DRAWINGS</a>  
    ...
    <a id="navmobi" href="{{ route('paintings') }}"  class="menu-link opacity-60 transition duration-500 ">PAINTINGS</a>
    <a id="navmobi" href="{{ route('drawings') }}" style="text-decoration: underline;text-underline-offset: 23px;text-decoration-thickness:2px; " class="menu-link flex items-center justify-center  text-[#6e4d41] hover:text-gray-500 font-medium h-[60px] px-3  transition duration-500 ">DRAWINGS</a>
    <a id="navmobi" href="{{ route('sculptures') }}" class="menu-link opacity-60 transition duration-500 ">SCULPTURE</a>
    <a id="navmobi" href="{{ route('artists') }}" class="menu-link opacity-60 transition duration-500 ">ARTISTS</a>
