...
<body  class="bg-white text-gray-900 min-h-screen max-h-[100vh]">
    ...
    <section>    
        <div class="bg-white p-4 rounded shadow-lg border mx-auto max-w-[100%] sm:max-w-[100%]" >
            ...
            <!-- Event List -->
            <div class="ml-10 mr-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
            ...
            <div class="p-4">
                <div class="flex flex-col md:flex-row md:justify-between md:items-start space-y-4 md:space-y-0">
                    ...
                    <div class="flex flex-col items-start md:items-end space-y-2 w-full md:w-auto">
                        ...
                        <button 
                        class="bg-[#6E4D41] text-white px-4 py-2 rounded whitespace-nowrap hover:bg-[#5a3e34] transition-colors w-full md:w-auto"
                         data-bs-toggle="modal" 
                         data-bs-target="#ViewDetailsModal{{$event->id}}">Event Info</button>
