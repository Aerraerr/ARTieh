        ...
        <div class="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div class="lg:w-2/3">
            ...
            <div class="mb-4 flex items-center gap-6">
              ...
              <input type="date" placeholder="" class="border border-gray-300 rounded w-[350px] p-2 focus:outline-none focus:ring-1 focus:ring-[#6E4D41]" />
            </div>
...
<script>
    ...
    function copyLink() {
        ...
        // Optionally show a success message (like a tooltip or alert)
