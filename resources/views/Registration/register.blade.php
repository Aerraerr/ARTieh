...
<body style="font-family:rubik;" class="bg-white text-gray-700">
    
    <!-- Navbar   style="height:3000px;" -->
    <nav style="height:60px;" class="flex justify-between items-center px-10 py-6  bg-transparent">
            ...
            <g id="progressive-webapps/loading-performance/first-meaningful-paint" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                ">
                    <g id="mask">
                        ...
                        <rect stroke="#EBD1B6" x="-1" y="-1" width="71" height="71" rx="14">
        ...
        <div class="flex justify-center">
            ...
            <form method="POST" action="/register" class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <input type="password" name="confirm_password" id="password" placeholder="Confirm password" class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-[#A99476] outline-none mt-1">
                </div>
